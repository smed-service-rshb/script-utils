rem Сборка приложения для стенда TEST в ООО "СоюзМедСервис" из веток, имя которых указано в первом параметре запуске скрипта
...
set BACKEND_SERVER_HOST=192.168.10.40
set BACKEND_SERVER_HOST_2=192.168.10.173
set API_GATEWAY_PORT=8081
set EFR_PRESENTATION_BASE_PATH=/efr
set DB_HOST=192.168.10.130
set ES_CLUSTER_NAME=test-systemjournal
...
set WAR_SETTINGS_DIR=_sms-test-stand
set DISTRIB_DIR_NAME=_distrib_sms_%BRANCH_NAME:/=_%_test
